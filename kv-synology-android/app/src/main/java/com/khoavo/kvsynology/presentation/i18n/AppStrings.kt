...
object ViStrings : AppStrings {
    ...
    override val expBeginnerDesc = "Chế độ Cơ bản: Hiển thị các tính năng cốt lõi (Tổng quan, Tệp tin, Docker, Tải xuống, Lưu trữ)."
...
object EnStrings : AppStrings {
    ...
    override val expBeginnerDesc = "Beginner Mode: Shows core features (Dashboard, Files, Docker, Downloads, Storage)."
