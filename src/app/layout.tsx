      ...
      <head>
        ...
        <script
          dangerouslySetInnerHTML={{
            __html: `try{const t=localStorage.getItem('dsm_theme')||'system';const m=window.matchMedia('(prefers-color-scheme: dark)').matches;const d=t==='dark'||(t==='system'&&m);if(d)document.documentElement.classList.add('dark');else document.documentElement.classList.remove('dark');}catch{}`,
          }}
        />
      </head>
